...
export const skillsData = {
  topTechStack: [
    ...
    { name: 'GitHub', level: 90, icon: <SiGithub className="text-black dark:text-white bg-white rounded-full" /> },
  ],
  frontend: [
    { name: 'HTML5', level: 95, icon: <SiHtml5 className="text-[#E34F26]" /> },
    { name: 'CSS3 / Tailwind', level: 90, icon: <div className="flex -space-x-1"><SiCss className="text-[#1572B6]" /><SiTailwindcss className="text-[#06B6D4] bg-white rounded-full" /></div> },
  ...
  tools: [
    { name: 'Git & GitHub', level: 90, icon: <div className="flex -space-x-1"><SiGit className="text-[#F05032]" /><SiGithub className="text-black dark:text-white bg-white rounded-full" /></div> },
